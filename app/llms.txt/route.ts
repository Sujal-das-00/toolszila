...
export function GET() {
  ...
  const body = [
    ...
    "",
    "Editorial policy:",
    "- Content is reviewed against documented methodology, versioned tax data, and published source links.",
    "- Educational estimates are separated from professional advice and filing decisions.",
    "",
    "Notes:",
